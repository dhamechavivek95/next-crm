...
/**
 * CustomerSearch represents the model behind the search form of `app\models\Contact`.
 */
class CustomerSearch extends Contact
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Contact::find()->where(['contact_type' => 'CUSTOMER']);
