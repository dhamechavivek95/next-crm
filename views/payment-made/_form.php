    ...
    <div class="panel">
        ...
        <div class="row">
            <div class="form-group input-sm">
                ...
                <?= $form->field($model, 'user_id',['options' => ['class' => ['col-sm-3 input-sm']]])->dropDownList(ArrayHelper::map(Contact::find()->where(['contact_type' => 'VENDOR'])->all(),'contact_id','display_name'),['prompt' => 'Select','class' => 'select2'])->label('Vendor') ?>
...
<?php
$this->registerJsFile('@web/js/payment-made.js', [
